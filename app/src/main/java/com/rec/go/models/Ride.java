...
/**
 Responsible for containing all the info of the ride-
...
public class Ride implements Cloneable{
     ...
     */
    public Ride(Activity activity, String id){
        this.id = id;
    ...
    public void parseData(DataSnapshot dataSnapshot){
        ...
        if(dataSnapshot.child("customerId").getValue() != null){
            mCustomer = new Customer(dataSnapshot.child("customerId").getValue().toString());
        }
        if(dataSnapshot.child("driverId").getValue() != null){
            mDriver = new Driver(dataSnapshot.child("driverId").getValue().toString());
        }
     ...
     * firebase functions and only then will  be available to the drivers.
     */
    ...
    public void recordRide(){
        ...
        new SendNotification("Add a tip to make your driver's day.","Ride ended", mCustomer.getNotificationKey());
    }
    ...
    public void showDialog(Activity activity) {
        try {
            Ride mTempRide = (Ride) this.clone();
