...
public class TypeAdapter  extends RecyclerView.Adapter<TypeAdapter.viewHolders> {
    ...
    private List<Type> itemArrayList;
    private ArrayList<Double> data;

    public TypeAdapter(List<Type> itemArrayList, Context context, ArrayList<Double> data) {
    ...
    public TypeAdapter.viewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_vehicle_type, null, false);
