...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if(wasOpened()) {
            startActivity(new Intent(this, AuthenticationActivity.LauncherActivity.class));
            finish();
        }
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), AuthenticationActivity.LauncherActivity.class));
                savePrefsData();
                finish();
            }
        });
