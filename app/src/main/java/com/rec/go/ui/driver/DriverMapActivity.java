...
import com.rec.go.adapters.CardRequestAdapter;
import com.rec.go.models.Driver;
import com.rec.go.ui.history.HistoryActivity;
import com.rec.go.ui.payment.PayoutActivity;
...
public class DriverMapActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback, DirectionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWorkingSwitch.setOnClickListener((buttonView) -> {
    ...
    private void logOut() {
        ...
        Intent intent = new Intent(DriverMapActivity.this, AuthenticationActivity.LauncherActivity.class);
        startActivity(intent);
        finish();
    }
