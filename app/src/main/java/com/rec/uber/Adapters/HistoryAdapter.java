...
import com.rec.uber.History.HistorySingleActivity;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryViewHolders> implements OnMapReadyCallback {
    ...
    private List<Ride> itemList;
    private Context context;

    public HistoryAdapter(List<Ride> itemList, Context context) {
