 ...
 */
public class CardRequestAdapter extends ArrayAdapter<Ride>{

    Context context;
    List<Ride> items;

    public CardRequestAdapter(Context context, int resourceId, List<Ride> items){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        Ride card_item = getItem(position);
