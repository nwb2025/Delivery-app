...
import com.rec.uber.Adapters.PayoutAdapter;
import com.rec.uber.models.Driver;
import com.rec.uber.models.Payout;
...
public class PayoutActivity extends AppCompatActivity {
    ...
    ArrayList<Payout> payoutArrayList = new ArrayList<>();
            ...
            public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for(DataSnapshot mData : dataSnapshot.getChildren()){
                        Payout mPayout = new Payout(PayoutActivity.this);
                        mPayout.parseData(mData);

                        boolean exists = false;
                        for(Payout mPayoutIt : payoutArrayList){
